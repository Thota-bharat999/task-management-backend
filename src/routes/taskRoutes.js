...
const{ createControllerTask, getAllTasksController, getTaskController, updateTaskController,deleteTaskController, getTaskStatisticsController }=require("../controllers/taskController")
...
router.get("/statistics",protect,authorizeRoles(["Admin","Manager"]),getTaskStatisticsController)
